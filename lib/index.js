...
var githubIssueToClubhouseStory = exports.githubIssueToClubhouseStory = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(githubIssueURL, clubhouseProject) {
    ...
    var projects, _projects$find, projectId, _parseGithubIssueURL, owner, repo, issueNumber, issue, issueComments, users, authorId, unsavedStory, story;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            ...
            authorId = githubUserToClubhouseUserId(issue.user, users);
            unsavedStory = _issueToStory(authorId, projectId, issue, issueComments, users);
...
function githubUserToClubhouseUserId(githubUser, clubhouseUsers) {
  var mapping = require('../users-mapping.json');

  var clubhouseUsername = mapping[githubUser.login];
  var clubhouseUser = clubhouseUsers.find(function (user) {
    return user.username === clubhouseUsername;
  });
